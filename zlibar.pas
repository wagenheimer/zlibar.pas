...
type
  ...
  *)
  ...
  private
    ...
    function InternalCompressStream(FileIndex: Integer; InStream: TMemoryStream; var OutStream: TMemoryStream): Integer;
  ...
  private
    ...
    procedure DoError(ErrorCode: Integer; ErrorString: String);
    function InternalExtractStream(InStream: TMemoryStream;var OutStream: TMemoryStream): Integer;
  ...
  public
    ...
    destructor Destroy; override;
  public
    procedure ExtractFileToStream(AIndex: Integer; var Stream: TMemoryStream);
    procedure ExtractFileToStream(const AFileName: String; var Stream: TMemoryStream);
    procedure ExtractFileToStream(const AFileName , APath: String; var Stream: TMemoryStream);
...
function CompressStream(InStream: TStream; var OutStream: TStream): Integer; //returns size of compressed file
function ExtractStream(InStream: TStream;var OutStream: TStream): Integer;
...
*   to OutputStream                                                            *
*******************************************************************************}
function CompressStream(InStream: TStream; var OutStream: TStream): Integer;
var
  err : integer;
  z : TZstream;
...
function TZlibWriteArchive.InternalCompressStream(FileIndex: Integer;
  InStream: TMemoryStream; var OutStream: TMemoryStream): Integer;
var
  err : integer;
  z : TZstream;
...
fChar: Char;
TmpStream: TStream; // used to temporarily hold the compressed TOC
TOCStream: TStream; // the TOC will be extracted into this
begin
  TmpStream:= TMemoryStream.Create;
  TOCStream := TMemoryStream.Create;
  try
...
function TZLibReadArchive.InternalExtractStream(InStream: TMemoryStream;
...
procedure TZLibReadArchive.ExtractFileToStream(AIndex: Integer;
...
begin
  ...
  //Check Md5 sum
  Md5Sum := StreamMD5(TMemoryStream(Stream));
...
procedure TZLibReadArchive.ExtractFileToStream(const AFileName: String;
  var Stream: TMemoryStream);
begin
  ExtractFileToStream(AFileName,'/',Stream);
end;

procedure TZLibReadArchive.ExtractFileToStream(const AFileName, APath: String;
  var Stream: TMemoryStream);
var
  i: Integer;
begin
